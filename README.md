...
- **2 à 20 participants** (nombre pair)
...
### Installation
Aucune installation nécessaire ! Il suffit de télécharger les fichiers et de lancer le fichier `tournament.html` dans votre navigateur.
...
Interface de saisie des participants avec upload de photos optionnel.

### Sélection des byes
Choix des têtes de série qui seront qualifiées d'office au 2ème tour.

### Bracket symétrique
Affichage professionnel du bracket avec layout gauche-centre-droite.

### Mode focus
Mise en avant du match en cours avec flou des autres matchs.

### Podium final
Célébration des 3 médaillés avec photos et animations.
...
Développé avec passion par **Etienne**
